...
_This blog have a legacy version built with **Gatsby** which can be found [here](https://Riken-blog-legacy.vercel.app/)_.
...
Copyright (c) 2023 Riken Patel (Riken) - Alrights reserved.
